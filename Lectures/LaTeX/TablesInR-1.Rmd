...
table1 <- data.frame(
  Variable = c('Age mean (sd)', 'Sex n (%)', 'Female', 'Male'),
...
source('/Users/f002yt8/Documents/QBS103/QBS103_24X/LectureNotes/LaTeX/TableOne.R')
...
Design your own function in a separate R script to build a table one like the one demonstrated above. Users should input a data frame and how different variables should be treated (i.e. normally or non-normally distributed, categorical). 
