...
4) The vector of words was taken from a 2020 Science article about rheumatoid arthritis (RA) associated joint damage. If you are interested in accessing the whole article it can be found [here](https://www.science.org/doi/10.1126/sciadv.abd2688). Using this vector of word and your recently acquired programming skills, select the word "rheumatoid" and print it out.
